...
if __name__ == "__main__":
    ...
    path_pred = "ConvNet/predictions/test003_prediction.csv"
    path_test = "leaderboard_data/test003.csv"
    ...
    print(f"Score: {get_score_fct(path_pred, path_test, log = False, vid = True)}")