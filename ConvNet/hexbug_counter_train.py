...
from traco.ConvNet.datasets import HexbugCountingDataset
from traco.ConvNet.models import HexbugCounter
...
def main():
    ...
    dataset = HexbugCountingDataset("../training", "../training", transform=transform)
